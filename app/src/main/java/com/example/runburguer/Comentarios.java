...
public class Comentarios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vuelvo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent volv = new Intent(Comentarios.this, MenuPrincipal.class);
                startActivity(volv);
    ...
    public void agregar(View view) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Comentarios.this, R.style.Theme_Material3_Dark_Dialog_Alert);
    ...
    public void ejecutarDatos(String URL) {
        stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("descripcion", QuejaoRec.getText().toString());
